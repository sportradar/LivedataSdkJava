...
* sdk-2.0.18.jar - only sdk classes, need to upload dependencies from maven.
* sdk-2.0.18-fatjar.jar - stores all needed libraries inside jar.
* sdk-2.0.18-fatjar-shaded.jar - stores all needed libraries inside jar. Libraries are shaded to avoid overwriting by newer versions.
