...
import com.sportradar.livedata.sdk.proto.dto.incoming.livescout.Login;
    ...
    protected void onMessageParsed(IncomingMessage message) {
        ...
        if(message instanceof Login){
            ...
            if(type == LiveScoutLoginType.VALID){
                ...
                logger.debug("LOGIN_FAILED: result={} | reason={} | error_code={}", login.getResult(), login.getReason(), login.getErrorcode());
            }
        }else{
